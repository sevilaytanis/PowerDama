...
*		File Version			: 1.0
*		Purpose					: KVKK Kapsamında Veri Silme Taleplerini Karşılayabilmek Adını Müşteri Verilerinin Ne Olduğunu Bulan Sistemin Yönetim Detay Tablosunu Günceller
*		Last Modified By		: karadayi
*		Last Modification Date	: 21/03/2018
*
*/
CREATE PROCEDURE [DTG].[upd_CustomerDataRequestDetail]
(
...
SET NOCOUNT ON
BEGIN
	UPDATE [DTG].[CustomerDataRequestDetail]
