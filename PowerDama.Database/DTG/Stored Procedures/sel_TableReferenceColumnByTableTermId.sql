...
*
*/
CREATE PROCEDURE [DTG].[sel_TableReferenceColumnByTableTermId]
(
	@TermId INT
)
AS
	...
	SELECT CLM.TableColumnDraftId AS TableColumnId,
		CLM.TableDraftId AS TableId,
		CLM.TermId,
		T.Name AS TermName,
		T.Level1Domain AS TermLevel1Domain,
		T.Level2Domain AS TermLevel2Domain,
