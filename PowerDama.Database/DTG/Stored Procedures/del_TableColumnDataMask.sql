...
*
*/
CREATE PROCEDURE [DTG].[del_TableColumnDataMask]
(
	@DBName VARCHAR(20),
...
SET NOCOUNT ON
BEGIN
	DECLARE @SubsetCriteria VARCHAR(50)

	SELECT @SubsetCriteria = SubsetCriteria
