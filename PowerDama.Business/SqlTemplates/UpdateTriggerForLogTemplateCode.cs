namespace PowerDama.Business.SqlTemplates
{
    ...
    /// 
    /// </summary>
    public partial class UpdateTriggerForLogTemplate
    {
        ...
        public UpdateTriggerForLogTemplate(string dBName, string logDBName, string schemaName, string tableName, string logTableName, string primaryColumnName)
        {
            DBName = dBName;
            LogDBName = logDBName;
